...
//alert("gamedashbord.php"+distance);

if(distance==60 || distance==175 || distance==170 || distance==165 || distance==160){
...
{ var formattedDate = $scope.selectedDate.toDateString();
  console.log("generateGameid"+formattedDate);
  var futureid=$('#futureid').val();
    ...
    success: function (html) {
      //alert(html);
    var arr = html.split('~');
    // Now 'arr' will contain the split parts of the string
    console.log(arr[0]); // Output the split parts to console for verification
   
	 //alert("gamingdashbod".arr[1]);
   //alert(arr[0]);
	 document.getElementById("gameid").innerHTML=formattedDate;
	 document.getElementById("inputgameid").value= formattedDate;
	 document.getElementById("futureid").value= formattedDate;
      return false;
      },
      error: function (e) {
      //alert(e);
