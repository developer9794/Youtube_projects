...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>DGasoline</b>Indicator</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form name="myform" id="myform" action="javascript:fnSubmit();">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="uname" id="uname" placeholder="Username" value="111">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="pass" id="pass" placeholder="Password" value="111">
